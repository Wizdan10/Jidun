    ...
    <nav class="navbar navbar-expand-lg navbar-light ">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-5 mb-2 mb-lg-0 ml-auto">
              <li class="nav-item ">
              <i class=" fas fa-user text-dark"><a href="login-user.php"class="text-dark" data-toogle="tooltip" title="Login">Login</a></i>
              </li>
          </div>
        </div>
    </nav>
