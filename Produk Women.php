    ...
    <html lang="en">
        ...
        <body>
            <nav class="navbar navbar-expand-lg navbar-light ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#" style="text-decoration: underline;">Women</a>
                    </li>
            ...
            <div class="navbar navbar-2">
                <div class="container">
                        <ul>
                            <img src="img-women/WOMEN_CARDIGAN-removebg-preview 1.png" class="mt-5" style="width: 200px; height:300px;" alt="WOMEN_CARDIGAN">
                            <div class="vertikal mt-5"></div>
                            <img src="img-women/women_Hoodie-removebg-preview 1.png" class="mt-5" style="width: 200px; height:300px;" alt="women_Hoodie">
                            <div class="font-3">
                                <li class="font-4"><p> KOLEKSI CARDIGAN DAN HOODIE</p></li>
                                <li class="font-5"><p>Koleksi yang wajib di miliki,<br/>nyaman untuk digunakan dan modis</p></li>
                            </div>
                        </ul> 
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                <?php
                    $kategori = mysqli_query($koneksi,"SELECT * FROM tb_product WHERE product_jenis = 1 ORDER BY category_id DESC");
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <a href="buy.php?idw=<?php echo $row['category_id'] ?>" class="btn cart text-white" name="add-cart" type="submit" value="+Cart" style="background-color: #D98C00;">+Cart</a>
                    </div>
                    <?php }}else{ ?>
                            <tr>
