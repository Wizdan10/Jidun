    ...
    <!-- AWAL NAVBAR VERTICAL -->
      <div class="row no-gutters">
        ...
        <div class="col-md-10 p-5 pt-2">
          <h3><i > <img src="img/add-item-alt-svgrepo-com 2.png" alt="Dashboard" style="width: 35px; margin-top: -10px; margin-right: 20px;"></i>DAFTAR BARANG</h3><hr>
          <a href="add-barang.php" class="btn btn-primary mb-3"><i class="fas fa-plus-square mr-2"></i>TAMBAH BARANG</a>
          <table class="table table-striped table-bordered">
            ...
            <?php 
                $no = 1;
                $kategori = mysqli_query($koneksi,"SELECT * FROM tb_product ORDER BY category_id DESC");
              ...
              <tr>
                ...
                <td><img src="product-men/<?php echo $row['product_image']?>" width="50px"></td>
                <td><?php echo ($row['product_status']==0)?'New':'Sale'; ?></td>
                <td><?php echo ($row['product_jenis']==0)?'laki-laki':'Perempuan'; ?></td>
                <td class="text-center"><a href="edit-kategori.php?id=<?php echo $row['category_id'] ?>"  class="btn btn-success  fas fa-edit" data-toogle="tooltip" title="Edit"></a></td>
                <td  class="text-center"><a href="proses-hapus.php?idk=<?php echo $row['category_id'] ?>" class="btn btn-danger fas fa-trash-alt " data-toogle="tooltip" title="Delete" onclick="return confirm('Anda Yakin Ingin Menghapus Data Tersebut?')"></a></td>
              </tr>
              <?php }}else{ ?>
                <tr>
